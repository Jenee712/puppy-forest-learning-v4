...
const gradeSpecificQuestions: Record<string, Omit<QuestionItem, "id" | "grade" | "eyebrow">> = {
  ...
  "G3:数学": { subject: "数学", knowledgePoint: "两步加减应用", type: "single_choice", difficulty: 2, source: "local_core", title: "先变化再比较", prompt: "图书角有28本绘本，上午借走9本，下午又归还6本。现在有多少本？", visual: "28 − 9 + 6", options: ["25本", "13本", "31本"], answer: "25本", explanation: "先算借走后剩28−9＝19本，再加归还的6本：19＋6＝25本。", mathModel: { kind: "steps", title: "按事情发生顺序计算", values: [{ label: "原有", value: "28本" }, { label: "借走", value: "−9本" }, { label: "归还", value: "+6本" }], relation: "28−9＋6" } },
  "G4:数学": { subject: "数学", knowledgePoint: "表格信息与两步运算", type: "single_choice", difficulty: 2, source: "local_core", title: "阅读借阅记录", prompt: "班级周一借出18本书，周二比周一少借5本，两天一共借出多少本？", visual: "周一18本｜周二比周一少5本", options: ["31本", "23本", "36本"], answer: "31本", explanation: "先求周二：18−5＝13本；再求两天总数：18＋13＝31本。", mathModel: { kind: "steps", title: "先补全表格，再求总数", values: [{ label: "周一", value: "18本" }, { label: "周二", value: "18−5＝13本" }, { label: "合计", value: "18＋13" }], relation: "18＋（18−5）" } },

  "G3:英语兴趣": { subject: "英语兴趣", knowledgePoint: "句子信息匹配", type: "single_choice", difficulty: 2, source: "local_core", title: "Read and choose", prompt: "Leo has a blue schoolbag. His red lunch box is inside it. Which sentence is true?", visual: "🎒 blue · lunch box red · inside", options: ["The lunch box is in the schoolbag.", "The schoolbag is red.", "Leo has two lunch boxes."], answer: "The lunch box is in the schoolbag.", explanation: "题干说明红色午餐盒在蓝色书包里面，需要同时分清物品、颜色和位置。", vocabulary: [{ term: "inside", phonetic: "/ˌɪnˈsaɪd/", tag: "位置词", meaning: "在……里面", expansion: "inside 强调位于某个空间内部。", example: "The key is inside the box.", exampleMeaning: "钥匙在盒子里面。" }, { term: "lunch box", phonetic: "/ˈlʌntʃ bɒks/", tag: "名词词组", meaning: "午餐盒", expansion: "由 lunch 和 box 组成的复合名词。", example: "My lunch box is yellow.", exampleMeaning: "我的午餐盒是黄色的。" }] },
  "G4:英语兴趣": { subject: "英语兴趣", knowledgePoint: "日程信息整合", type: "single_choice", difficulty: 2, source: "local_core", title: "Read Leo's timetable", prompt: "Leo has art on Monday and Thursday. He has football practice only on Wednesday. Today he is carrying paints, but no football shoes. What day could it be?", visual: "art: Mon/Thu｜football: Wed｜today: paints", options: ["Monday or Thursday.", "Wednesday only.", "Saturday only."], answer: "Monday or Thursday.", explanation: "颜料对应美术课；美术课安排在星期一和星期四，因此两天都有可能。", vocabulary: [{ term: "timetable", phonetic: "/ˈtaɪmteɪbəl/", tag: "名词", meaning: "课程表；时间表", expansion: "阅读时间表时要同时核对日期和活动。", example: "Check the timetable before school.", exampleMeaning: "上学前查看课程表。" }, { term: "carry paints", phonetic: "/ˈkæri peɪnts/", tag: "动词词组", meaning: "带着颜料", expansion: "carry 表示随身携带。", example: "She carries paints to art class.", exampleMeaning: "她带颜料去上美术课。" }], grammarTip: { title: "根据多条信息推断", pattern: "课程安排 + 随身物品 → 可能的日期", explanation: "先找物品对应的课程，再在课程表中定位日期，答案可能不止一个日期但只有一个选项完整。" } },
...
export const subjectDailyExtras: Record<string, Record<string, Array<Omit<QuestionItem, "id" | "grade" | "eyebrow">>>> = {
  ...
  数学: {
    ...
    G4: [
      { subject: "数学", knowledgePoint: "除数是两位数的除法", type: "single_choice", difficulty: 2, source: "local_core", title: "装书", prompt: "280本书，每40本装一箱，需要几个箱子？", visual: "📚 280 ÷ 40", options: ["7个", "6个", "8个"], answer: "7个", explanation: "280÷40＝7，因为28÷4＝7。" },
      { subject: "数学", knowledgePoint: "面积单位换算", type: "single_choice", difficulty: 2, source: "local_core", title: "单位换算", prompt: "1平方米等于多少平方分米？", visual: "1㎡ = ? 平方分米", options: ["100平方分米", "10平方分米", "1000平方分米"], answer: "100平方分米", explanation: "相邻面积单位间的进率是100，1平方米＝100平方分米。" },
      { subject: "数学", knowledgePoint: "小数初步", type: "single_choice", difficulty: 2, source: "local_core", title: "比大小", prompt: "0.6和0.9，哪个更大？", visual: "0.6 vs 0.9", options: ["0.9", "0.6", "一样大"], answer: "0.9", explanation: "十分位6＜9，所以0.6＜0.9。" },
    ],
    G5: [
      { subject: "数学", knowledgePoint: "简易方程", type: "single_choice", difficulty: 2, source: "local_core", title: "解方程", prompt: "x＋15＝32，x等于多少？", visual: "x + 15 = 32", options: ["17", "47", "32"], answer: "17", explanation: "等式两边同时减15：x＝32−15＝17。" },
      { subject: "数学", knowledgePoint: "长方体体积", type: "single_choice", difficulty: 2, source: "local_core", title: "纸箱体积", prompt: "一个长方体纸箱长4分米、宽3分米、高2分米，体积是多少？", visual: "📦 4×3×2", options: ["24立方分米", "9立方分米", "14立方分米"], answer: "24立方分米", explanation: "体积＝长×宽×高＝4×3×2＝24立方分米。" },
      { subject: "数学", knowledgePoint: "因数与倍数", type: "single_choice", difficulty: 2, source: "local_core", title: "找因数", prompt: "12的因数一共有几个？", visual: "12 = ?×?", options: ["6个", "4个", "8个"], answer: "6个", explanation: "12的因数是1、2、3、4、6、12，共6个。" },
    ],
    G6: [
      { subject: "数学", knowledgePoint: "百分数应用", type: "single_choice", difficulty: 2, source: "local_core", title: "出勤率", prompt: "全班40人，今天出勤38人，出勤率是多少？", visual: "38/40 = ?%", options: ["95%", "90%", "80%"], answer: "95%", explanation: "出勤率＝出勤人数÷总人数＝38÷40＝0.95＝95%。" },
      { subject: "数学", knowledgePoint: "圆面积", type: "single_choice", difficulty: 2, source: "local_core", title: "圆形草坪", prompt: "圆形草坪的半径是3米，面积约是多少平方米？（π取3.14）", visual: "⭕ r=3m", options: ["28.26平方米", "18.84平方米", "9.42平方米"], answer: "28.26平方米", explanation: "圆面积＝πr²＝3.14×3×3＝28.26平方米。" },
      { subject: "数学", knowledgePoint: "比例基本性质", type: "single_choice", difficulty: 2, source: "local_core", title: "解比例", prompt: "2∶5＝x∶10，x等于多少？", visual: "2:5 = x:10", options: ["4", "5", "25"], answer: "4", explanation: "内项积等于外项积：5x＝2×10，x＝4。" },
    ],
    G7: [
      { subject: "数学", knowledgePoint: "有理数运算", type: "single_choice", difficulty: 2, source: "local_core", title: "负数计算", prompt: "气温从−3℃升高了8℃，现在是多少摄氏度？", visual: "🌡️ −3 + 8", options: ["5℃", "−5℃", "11℃"], answer: "5℃", explanation: "−3＋8＝5，比0℃高5℃。" },
      { subject: "数学", knowledgePoint: "代数式", type: "single_choice", difficulty: 2, source: "local_core", title: "用字母表示", prompt: "一支笔a元，买3支需要多少元？", visual: "✏️ a 元 × 3", options: ["3a元", "a＋3元", "a³元"], answer: "3a元", explanation: "单价×数量＝3×a＝3a元。" },
      { subject: "数学", knowledgePoint: "一元一次方程", type: "single_choice", difficulty: 2, source: "local_core", title: "解方程", prompt: "2x−6＝10，x等于多少？", visual: "2x − 6 = 10", options: ["8", "2", "16"], answer: "8", explanation: "两边加6得2x＝16，再除以2得x＝8。" },
    ],
    G8: [
      { subject: "数学", knowledgePoint: "勾股定理", type: "single_choice", difficulty: 3, source: "local_core", title: "直角三角尺", prompt: "一个直角三角形的两条直角边分别是3厘米和4厘米，斜边是多少厘米？", visual: "📐 3cm & 4cm", options: ["5厘米", "7厘米", "12厘米"], answer: "5厘米", explanation: "勾股定理：斜边²＝3²＋4²＝9＋16＝25，斜边＝√25＝5厘米。" },
      { subject: "数学", knowledgePoint: "一次函数", type: "single_choice", difficulty: 3, source: "local_core", title: "骑车路程", prompt: "小明骑车速度是每分钟300米，骑了x分钟后路程y米。y与x的关系是？", visual: "🚴 300米/分", options: ["y＝300x", "y＝x＋300", "y＝300÷x"], answer: "y＝300x", explanation: "路程＝速度×时间，速度固定为300，所以 y＝300x，是正比例函数。" },
      { subject: "数学", knowledgePoint: "数据的分析", type: "single_choice", difficulty: 3, source: "local_core", title: "找中位数", prompt: "5名同学的身高（厘米）是：150、158、155、152、160。这组数据的中位数是多少？", visual: "📏 150 152 155 158 160", options: ["155厘米", "152厘米", "158厘米"], answer: "155厘米", explanation: "先按从小到大排序：150、152、155、158、160，中间的数是155，即中位数。" },
    ],
  },
  // __ANCHOR_MORE__
  科学: {
