...
const gradeSpecificQuestions: Record<string, Omit<QuestionItem, "id" | "grade" | "eyebrow">> = {
  "G2:英语兴趣": { subject: "英语兴趣", knowledgePoint: "字母与首音", type: "single_choice", difficulty: 1, source: "local_core", title: "D is for dog", prompt: "哪一组是大写 D、小写 d 和对应单词？", visual: "D d · dog 🐶", options: ["D d · dog", "B b · ball", "C c · cat"], answer: "D d · dog", explanation: "D 和 d 是同一个字母的大小写，dog 以字母 d 开头。", vocabulary: [{ term: "dog", phonetic: "/dɒɡ/", tag: "名词", meaning: "小狗", expansion: "dog 的第一个字母是 d。", example: "The dog can run.", exampleMeaning: "小狗会跑。" }] },
  "G2:语言表达": { subject: "语言表达", knowledgePoint: "连续动作表达", type: "single_choice", difficulty: 1, source: "local_core", title: "按顺序说清楚", prompt: "小熊先穿外套，再背书包，最后出门。哪句话把顺序说清楚了？", visual: "🧥 → 🎒 → 🚪", options: ["小熊穿好外套，背上书包，然后出门。", "小熊出门。", "书包和外套。"], answer: "小熊穿好外套，背上书包，然后出门。", explanation: "完整表达要按照先后顺序说清楚小熊做了哪些事。" },
  "G2:数量与空间": { subject: "数量与空间", knowledgePoint: "10以内数量比较", type: "single_choice", difficulty: 1, source: "local_core", title: "哪一篮更多", prompt: "左篮有6个苹果，右篮有4个苹果。哪一篮更多？", visual: "左篮 🍎×6｜右篮 🍎×4", options: ["左篮", "右篮", "一样多"], answer: "左篮", explanation: "6比4大，所以装有6个苹果的左篮更多。" },
  "G2:科学探索": { subject: "科学探索", knowledgePoint: "物体沉浮", type: "single_choice", difficulty: 1, source: "local_core", title: "水中小实验", prompt: "把干树叶和小石子轻轻放进水里，哪一个更可能沉到水底？", visual: "🍂 + 🪨 → 💧", options: ["小石子", "干树叶", "两个都会飞起来"], answer: "小石子", explanation: "小石子通常比同样大小的水更密实，放进水里更容易下沉。" },
  "G2:健康习惯": { subject: "健康习惯", knowledgePoint: "咳嗽礼仪", type: "single_choice", difficulty: 1, source: "local_core", title: "咳嗽时怎么做", prompt: "突然想咳嗽时，怎样做更卫生？", visual: "😷 💪", options: ["用纸巾或手肘遮住口鼻", "对着别人咳嗽", "用手摸完口鼻就拿食物"], answer: "用纸巾或手肘遮住口鼻", explanation: "遮住口鼻并及时洗手，可以减少飞沫传播。" },
  "G2:社会认知": { subject: "社会认知", knowledgePoint: "公共规则", type: "single_choice", difficulty: 1, source: "local_core", title: "图书馆小规则", prompt: "在图书馆看完绘本后，怎么做更合适？", visual: "📚 🤫", options: ["轻轻放回指定位置", "扔在地上", "大声喊朋友来抢"], answer: "轻轻放回指定位置", explanation: "爱护图书并保持安静，是大家共同遵守的公共规则。" },
  "G2:艺术创造": { subject: "艺术创造", knowledgePoint: "图形组合", type: "single_choice", difficulty: 1, source: "local_core", title: "图形变变变", prompt: "一个大圆加上两个小圆，最适合添画成哪一种动物的脸？", visual: "⚪ + ◯ ◯", options: ["小熊", "长颈鹿", "小鱼"], answer: "小熊", explanation: "大圆可以画脸，两个小圆可以画耳朵，组合起来很像小熊。" },
  ...
  "G4:科学": { subject: "科学", knowledgePoint: "蒸发现象", type: "single_choice", difficulty: 1, source: "local_core", title: "水迹去哪了", prompt: "操场上的一小滩水被太阳照了一会儿，慢慢不见了。最合理的解释是什么？", visual: "☀️ + 💧 → 水蒸气", options: ["水受热变成水蒸气进入空气", "水钻进了塑胶跑道", "阳光把水变成了沙子"], answer: "水受热变成水蒸气进入空气", explanation: "液态水受热后会蒸发，变成看不见的水蒸气进入空气。" },
  "G5:科学": { subject: "科学", knowledgePoint: "声音传播", type: "single_choice", difficulty: 2, source: "local_core", title: "隔门还能听见", prompt: "房门关着时，屋外仍能听见屋内的音乐。这说明什么？", visual: "🎵 → 🚪 → 👂", options: ["声音可以通过空气和门传播", "声音只能在水里传播", "关门后声音会立刻消失"], answer: "声音可以通过空气和门传播", explanation: "声音需要介质传播，空气和门都能传递一部分振动。" },
  "G6:科学": { subject: "科学", knowledgePoint: "导体与绝缘体", type: "single_choice", difficulty: 2, source: "local_core", title: "安全选择材料", prompt: "制作简单电路开关的手柄，下面哪种材料更适合用来减少触电风险？", visual: "电路开关 · 手柄材料", options: ["干燥塑料", "铜片", "铁钉"], answer: "干燥塑料", explanation: "干燥塑料通常不容易导电，适合作为绝缘手柄；金属容易导电。" },
  "G7:科学": { subject: "科学", knowledgePoint: "生态关系", type: "single_choice", difficulty: 2, source: "local_core", title: "池塘食物链", prompt: "池塘中水草减少后，以水草为食的小虾数量也下降。这个现象最能说明什么？", visual: "水草 ↓ → 小虾 ↓", options: ["生物之间存在食物和生存联系", "小虾完全不需要食物", "水草减少一定会让所有动物增加"], answer: "生物之间存在食物和生存联系", explanation: "水草是小虾的食物和栖息条件之一，水草变化会影响小虾数量。" },

  "G4:阅读与表达": { subject: "阅读与表达", knowledgePoint: "原因推断", type: "single_choice", difficulty: 1, source: "local_core", title: "雨伞为什么是湿的", prompt: "窗外阳光明亮，小杰进门后却把一把湿雨伞放在门口。最可能发生了什么？", visual: "湿雨伞 + 现在晴天", options: ["小杰来时路上刚下过雨", "雨伞自己冒出了水", "今天从来没有下雨"], answer: "小杰来时路上刚下过雨", explanation: "湿雨伞是已经用过的线索，即使现在天晴，也可以推断不久前下过雨。" },
  "G5:阅读与表达": { subject: "阅读与表达", knowledgePoint: "人物心情推断", type: "single_choice", difficulty: 2, source: "local_core", title: "从动作猜心情", prompt: "演出前，安安一遍遍检查台词卡，手心微微出汗。她此时最可能是什么心情？", visual: "台词卡 · 反复检查 · 手心出汗", options: ["紧张", "无聊", "愤怒"], answer: "紧张", explanation: "反复检查和手心出汗都是演出前紧张的表现。" },
  "G6:阅读与表达": { subject: "阅读与表达", knowledgePoint: "段落概括", type: "single_choice", difficulty: 2, source: "local_core", title: "概括社区行动", prompt: "居民先记录夜间噪声出现的时间，又和商户协商调整卸货时段。一周后，夜间明显安静了。这段话主要写什么？", visual: "记录问题 → 协商调整 → 环境改善", options: ["居民通过调查和协商解决噪声问题", "商户停止了所有营业活动", "居民只记录了一个晚上的天气"], answer: "居民通过调查和协商解决噪声问题", explanation: "记录、协商和结果构成完整过程，第一项概括了问题如何得到改善。" },
  "G7:阅读与表达": { subject: "阅读与表达", knowledgePoint: "观点与事实", type: "single_choice", difficulty: 2, source: "local_core", title: "区分事实和看法", prompt: "下面哪一句属于可以核对的事实，而不是个人看法？", visual: "事实可查证｜看法有主观判断", options: ["校图书馆本月新增了120本书", "新阅览室是全城最漂亮的", "这本故事一定最感人"], answer: "校图书馆本月新增了120本书", explanation: "新增书的数量可以查阅记录核对；“最漂亮”“最感人”都带有个人评价。" },

  "G4:综合素养": { subject: "综合素养", knowledgePoint: "任务分工", type: "single_choice", difficulty: 1, source: "local_core", title: "小组怎样分工", prompt: "四人小组要做一张动物海报，怎样安排更有效？", visual: "查资料 · 写文字 · 画插图 · 检查", options: ["根据任务分工，完成后一起检查", "四个人都只画同一只动物", "让一个人做完，其他人等待"], answer: "根据任务分工，完成后一起检查", explanation: "明确分工能提高效率，共同检查能减少遗漏。" },
  "G5:综合素养": { subject: "综合素养", knowledgePoint: "信息安全", type: "single_choice", difficulty: 2, source: "local_core", title: "陌生链接要当心", prompt: "陌生人发来“点击链接领取游戏金币”的消息，最合适的做法是什么？", visual: "陌生消息 + 可疑链接", options: ["不点击，并告诉家长或老师", "马上填写姓名和密码", "转发给所有同学试一试"], answer: "不点击，并告诉家长或老师", explanation: "陌生链接可能骗取个人信息，应停止操作并向可信任的成年人求助。" },
  "G6:综合素养": { subject: "综合素养", knowledgePoint: "计划管理", type: "single_choice", difficulty: 2, source: "local_core", title: "安排项目时间", prompt: "科学报告三天后提交，包含查资料、做实验和整理结果。怎样安排更可靠？", visual: "3天 · 资料 · 实验 · 整理", options: ["拆分任务并给每一步留出时间", "等最后一晚再全部完成", "只做自己最喜欢的一步"], answer: "拆分任务并给每一步留出时间", explanation: "分步骤安排并预留检查时间，能降低遗漏和拖延风险。" },
  "G7:综合素养": { subject: "综合素养", knowledgePoint: "冲突协商", type: "single_choice", difficulty: 2, source: "local_core", title: "两种方案怎么选", prompt: "小组对展示方式有两种意见，怎样做更容易形成合理决定？", visual: "方案A ↔ 方案B", options: ["列出目标和优缺点后共同表决", "谁声音大就听谁的", "不讨论，直接取消展示"], answer: "列出目标和优缺点后共同表决", explanation: "先比较方案是否符合目标，再用大家认可的方式决定，更公平也更有效。" },
  "G8:综合素养": { subject: "综合素养", knowledgePoint: "来源核验", type: "single_choice", difficulty: 3, source: "local_core", title: "核对网络消息", prompt: "班级群转发一条没有作者和出处的“停课通知”。首先应该怎么核实？", visual: "群消息 → 查官方渠道 → 再判断", options: ["查看学校官方通知或联系老师", "看到多人转发就相信", "修改内容后继续转发"], answer: "查看学校官方通知或联系老师", explanation: "重要通知应核对发布主体、原始出处和官方渠道，转发次数不能证明真假。" },
